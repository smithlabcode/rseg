...
#ifndef THREE_STATE_SPLIT_HMM_HPP
#define THREE_STATE_SPLIT_HMM_HPP

#include "smithlab_utils.hpp"
#include "SplitDistro.hpp"
#include <memory>

class ThreeStateSplitHMM {
public:
  
  ThreeStateSplitHMM(const double mp, const double tol,
...
private:
  ...
  double
  log_sum_log(const double p, const double q, const double r) const;
