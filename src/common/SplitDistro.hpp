...
public:
  ...
  SplitDistro_ &
  operator=(const SplitDistro_ &);
  virtual ~SplitDistro_();

  virtual size_t
  required_params() const = 0;
  ...
  virtual double
  log_likelihood(double val) const = 0;
  virtual double
  log_likelihood(const double val, const double scale) const = 0;
  double
  log_likelihood(const std::vector<double> &vals) const;
  double
  ...
  virtual void
  estimate_params_ml(const std::vector<double> &, const std::vector<double> &,
                     const std::vector<double> &) = 0;
  virtual void
  ...
  virtual void
  set_params(const std::vector<double> &p) {
    params = p;
  }
  static double
...
public:
  ...
  log_likelihood(std::vector<double>::const_iterator a,
                 std::vector<double>::const_iterator b) const;
  double
  log_likelihood(double val) const;
  double
  log_likelihood(const double val, const double scale) const;
  std::string
  tostring() const;
  std::vector<double>
  get_params() const {
...
public:
  ...
  SkellamDistro &
  operator=(const SkellamDistro &rhs);
  ~SkellamDistro() {}
...
public:
  ...
  GaussianDistro &
  operator=(const GaussianDistro &rhs);
  ~GaussianDistro() {}
...
public:
  ...
  NegBinomDiffDistro &
  operator=(const NegBinomDiffDistro &rhs);
  ~NegBinomDiffDistro() {}
  ...
  void
  hq_estimate_params_ml(const std::vector<double> &vals_a,
                        const std::vector<double> &vals_b);
  void
  andrew_estimate_params_ml(const std::vector<double> &vals_a,
                            const std::vector<double> &vals_b);
  void
  estimate_params_ml(const std::vector<double> &vals_a,
                     const std::vector<double> &vals_b);
